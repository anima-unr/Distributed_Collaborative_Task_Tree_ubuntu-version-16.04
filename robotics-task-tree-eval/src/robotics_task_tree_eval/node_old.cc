...
Node::Node(NodeId_t name, NodeList peers, NodeList children, NodeId_t parent,
  ...
  // state_.peer_active_robot_id[1] = false;
  // state_.peer_active_robot_id[2] = false;
...
void Node::PublishStatus() {
  ...
  // msg.peer_active_robot_id[1] = state_.peer_active_robot_id[1];
  // msg.peer_active_robot_id[2] = state_.peer_active_robot_id[2];
